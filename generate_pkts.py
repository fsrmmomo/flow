...
import shutil
from common_utils import save_json, debug, info, check_file, check_dir, dir_exsit
from log_utils import info, debug, err
        ...
        with open(self.out_fn, 'w') as fp:
            for idx, pkt in enumerate(raw_pkts):
                ...
                if recorded_pkts[specifier] == num_pkts[specifier]:
                    finished = 1
                    # identify = list(specifier)
                    # print(type(identify), len(identify))
                    # print(identify)
...
if __name__ == '__main__':
    pcaps_fns = {
        "video": ["E:/研究生/项目/21-01-19-OAI流类型识别/pcap文件/video", "E:/PyCharm/Project/testAccuracy/tmp/pkts/video"],
        # "iot":["E:/研究生/项目/21-01-19-OAI流类型识别/pcap文件/converted_iot","E:/PyCharm/Project/testAccuracy/tmp/pkts/iot"],
        # "voip":["E:/研究生/项目/21-01-19-OAI流类型识别/pcap文件/voip/","E:/PyCharm/Project/testAccuracy/tmp/pkts/voip"]
        # "AR":["E:/研究生/项目/21-01-19-OAI流类型识别/pcap文件/AR/","E:/PyCharm/Project/testAccuracy/tmp/pkts/AR"]
    }
